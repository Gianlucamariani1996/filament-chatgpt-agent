...
<div class="relative w-full" id="chatgpt-agent-window" style="{{ $winWidth }}">
    ...
    <x-filament::section
        class="flex-1 p-2 sm:p-6 justify-between max-h-screen fixed {{ $winPosition == 'left' ? 'left-0' : 'right-0' }} bottom-0 bg-white shadow z-30 dark:bg-gray-900 {{ $panelHidden ? 'hidden' : '' }}"
